...
tmp_path = f"{args.output_path}/{args.model_name}.ckpt"
...
os.system(f"python unwrap_model.py --model-config {args.model_config} --ckpt-path {tmp_path} --name {args.output_path}/{args.model_name}")
